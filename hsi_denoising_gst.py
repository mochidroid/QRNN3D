...
if __name__ == '__main__':
    ...
    # load=h5py.File, 
    # size=None) for name in mat_names]

    # mat_datasets = [
    #     MatDataFromFolder(
    #         basefolder,
    #         load=lambda fn: LoadMatHSI(input_key='input', gt_key='gt')(h5py.File(fn, 'r')),
    #         suffix='mat'
    #     )
    # ]
    ...
    while engine.epoch < 100:
        ...
        engine.validate(mat_loaders[0], 'icvl-validate-gst')
